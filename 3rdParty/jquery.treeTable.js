    ...
    return this.each(function() {
	  ...
	  $(this).addClass("treeTable").find("tbody tr").each(function() {
        ...
        if (!$(this).hasClass('initialized')) {
          ...
          if(!isRootNode && options.expandable && options.initialState == "collapsed" && theHiddenFlag)  {
		...
		if( isRootNode )
		{
			theHiddenFlag = !$(this).hasClass('expanded');
		}
		else 
		{
			theHiddenFlag = $(this).hasClass('ui-helper-hidden');
		}
    ...
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        ...
        if(options.expandable) {
          var newLink = '<a href="#" title="' + options.stringExpand + '" style="margin-left:0px; padding-left: ' + options.indent + 'px" class="expander"></a>';
