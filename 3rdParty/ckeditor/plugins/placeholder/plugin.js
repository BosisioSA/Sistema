...
( function() {
	CKEDITOR.plugins.add( 'placeholder', {
		...
		onLoad: function() {
			...
			CKEDITOR.addCss( '.cke_placeholder{background-color:#A8DBFF;outline: 1px solid #0080BF;}.cke_widget_wrapper:hover>.cke_widget_element{outline: 1px solid #0080BF;}' );
		},
		...
		init: function( editor ) {
			...
			editor.widgets.add( 'placeholder', {
				...
				data: function() {
					this.element.setText( '${' + this.data.name + '}' );  // visible
				},
